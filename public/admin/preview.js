(function registerPreviews() {
  ...
  const register = () => {
    if (isRegistered() || !window.CMS || !window.React) {
      return false;
    }
    ...
    const HeroesPreview = ({ entry, widgetFor }) => {
      ...
      return h(
        ...
        h('div', { className: 'section' }, widgetFor('body'))
      );
    };
